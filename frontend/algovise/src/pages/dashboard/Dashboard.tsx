...
const Dashboard: React.FC = () => {
  const tiles = [
    ...
    {
      title: "Articles", path: "/articles", icon: <svg className="icon icon-tabler icon-tabler-article fs-1 mx-3 my-3" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--bs-success-border-subtle)" }}>
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
