...
const QuizRealWorldGraphAlgorithms: React.FC = () => {
  ...
  useEffect(() => {
    fetch("/quizzes/real-world-graph-algorithms/real-world-graph-algorithms.json")
    ...
    if (allCorrect) {
      ...
      try {
        const response = await fetch(
          `http://localhost:8080/completed-quizzes?userId=${userId}&quizId=6`,
          {
            method: "POST",
            headers: {
...
export default QuizRealWorldGraphAlgorithms;
