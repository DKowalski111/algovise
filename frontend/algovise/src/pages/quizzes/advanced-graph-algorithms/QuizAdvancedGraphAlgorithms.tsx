...
const QuizAdvancedGraphAlgorithms: React.FC = () => {
  ...
  useEffect(() => {
    fetch("/quizzes/advanced-graph-algorithms/advanced-graph-algorithms.json")
    ...
    if (allCorrect) {
      ...
      try {
        const response = await fetch(
          `http://localhost:8080/completed-quizzes?userId=${userId}&quizId=3`,
          {
            method: "POST",
            headers: {
...
export default QuizAdvancedGraphAlgorithms;
